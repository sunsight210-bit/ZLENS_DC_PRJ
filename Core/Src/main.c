...
void SystemClock_Config(void)
{
  ...
  */
  ...
  RCC_OscInitStruct.PLL.PLLMUL = RCC_PLL_MUL16;              // 4x16 = 64MHz
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, FRAM_WP_Pin|FRAM_CS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : FRAM_WP_Pin FRAM_CS_Pin */
  GPIO_InitStruct.Pin = FRAM_WP_Pin|FRAM_CS_Pin;
